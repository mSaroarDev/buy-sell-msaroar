...
export default function EditModal({ data }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            setSubmitting(true)
            const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/ads/delete`, {
                method: "DELETE",
                headers: {
      ...
      <div className="modal-box">
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          ...
          <div className="flex items-center justify-center gap-3 w-full mt-5">
            <button type="submit" className="bg-red-600 py-2 px-4 rounded-md text-white hover:bg-red-600/20 hover:text-red-600">
              Yes, Delete
            </button>
